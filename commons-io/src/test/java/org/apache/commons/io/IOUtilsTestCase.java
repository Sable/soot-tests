...
public class IOUtilsTestCase extends FileBasedTestCase {
    ...
    public void testConstants() throws Exception {
        ...
        if (WINDOWS) {
          ...
          System.out.println("separator: '"+ IOUtils.DIR_SEPARATOR_UNIX +"'");
          System.out.println("separator: '"+ String.valueOf(IOUtils.DIR_SEPARATOR) +"'"+ java.lang.Character.getNumericValue(IOUtils.DIR_SEPARATOR) +"   "+  File.separatorChar);
          System.out.println("separator: '"+ IOUtils.LINE_SEPARATOR +"'");
            assertEquals('/', IOUtils.DIR_SEPARATOR);
            assertEquals("\n", IOUtils.LINE_SEPARATOR);
        }
    }
